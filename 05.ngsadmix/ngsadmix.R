setwd("C:/Users/Jag/Documents/LMU/work/01.capture/03.ngsadmix")
...
#colors=c("black","#E5383E","#2c4574","#ff924c","#ffca3a","#c5ca30","#8ac926","#52a675","#1982c4","#4267ac","#6a4c93","#4A8791","#45355a","#e50008","#de5500","#d09900","#848820","#37704f","#325b61","#473363","#2e233c")


mainlines = c(0,10,15,25,36,46,56,69,82,94,105,115,125,130,140,150,160,170,180,189,199,209,219)
dotlines = c(1:218)
# Colors you need to change manually,PITA
colorscrambles = list()
colorscrambles[[2]] = c(3,2)
colorscrambles[[3]] = c(2,10,3)
colorscrambles[[4]] = c(3,2,6,10)
colorscrambles[[5]] = c(1,2,10,3,6)
colorscrambles[[6]] = c(4,6,2,1,3,10)
colorscrambles[[7]] = c(6,3,4,1,12,2,10)
colorscrambles[[8]] = c(4,2,8,1,6,10,12,3)
colorscrambles[[9]] = c(3,4,8,7,9,6,2,1,5)
...
layout(c(1:7)) #11 is max clusters
for (i in 2:7) { #11 is max clusters
  # new_K11_50reps.qopt
  Q = t(as.matrix(read.table(paste0("219_out_maxdepth_K",i,
                                    "_50reps.qopt"))))
  # The order of populations you want to show on the plot
  col.order <- c(1:35,36:75,76,77:219) 
