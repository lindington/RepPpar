...
snpsfile <- read.csv("01.output/dadi_parent.bcf", sep="\t", header=FALSE, row.names = NULL, skip = 47, colClasses=c(NA, NA, rep("NULL",68)))

### get linked snps from this
write(snpsfile$V2,"linkedsnps_parent.txt")
...
write(snps,"randomsnps_parent.txt")